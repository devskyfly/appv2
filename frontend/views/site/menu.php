...
<div class="col-xs-12 col-md-4">
            ...
            <div class="">
                <h2 style="color: rgb(51, 122, 183); text-align: center;">Общие положения</h2>
            </div>
    ...
    <div class="col-xs-12 col-md-4">
        ...
        <div> 
            <h2 style="color: rgb(51, 122, 183); text-align: center;">Деятельность ГСК</h2>
        </div>
...
<div class="col-xs-12 col-md-4">
        ...
        <div class="">
            <h2 style="color: rgb(51, 122, 183); text-align: center;">Бухгалтерия</h2>
        </div>
